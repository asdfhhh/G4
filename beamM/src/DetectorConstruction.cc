...
* Last modified:	2021-05-19 15:41
...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
	...
	experimentalHall_box = new G4Box("expHall_box",100*cm,100*cm,100*cm);
	...
	detector_tubs = new G4Tubs("detector_tubs",0*mm,0.02*mm,100*mm,0*deg,360*deg);
	detector_log = new G4LogicalVolume(detector_tubs,Al,"detector_log",0,0,0);
